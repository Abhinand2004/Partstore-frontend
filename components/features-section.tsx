...
const FeaturesSection = () => {
    return (
        <section
            className="w-full bg-white border-b border-[#F3F4F6] py-12 lg:py-[48px]"
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
                    {features.map((feature, index) => (
                        <div
                            key={index}
                            className="flex flex-row items-start gap-[16px] p-[24px_24px_0px] rounded-[14px] transition-all duration-300 hover:bg-[#F9FAFB] border border-transparent hover:border-[#F3F4F6] mx-auto lg:mx-0"
                            style={{
                                width: "100%",
                                maxWidth: "286px",
                                height: "140px",
                        ...
                        >
                            {/* Icon Container */}
                            <div
                                className="flex flex-shrink-0 items-center justify-center w-16 h-16 rounded-[14px]"
                                style={{
                                    background: "linear-gradient(135deg, rgba(94, 181, 154, 0.1) 0%, rgba(94, 181, 154, 0.05) 100%)"
                                }}
                            >
                            ...
                            {/* Text Container */}
                            <div className="flex flex-col gap-[4px] min-w-0" style={{ width: "158px", height: "92px" }}>
                                <h2
                                    className="font-medium text-[16px] leading-[24px] text-[#101828]"
                                    style={{ letterSpacing: "-0.3125px" }}
                                >
                                    {feature.title}
                                </h2>
                                <p
                                    className="font-normal text-[14px] leading-[20px] text-[#4A5565]"
